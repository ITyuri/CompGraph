...
vector<string> object_paths = { "objects/simple_floor.obj", "objects/19836_Loo_Table_v1.obj", "objects/WinnerCup.obj", "objects/square_plate.obj", "objects/glass.obj" };
vector<string> object_texture_paths = { "objects/glass.jpg", "objects/WoodSeemles.jpg", "objects/table_wood.jpg", "objects/plate.jpg", "objects/glass.jpg" };
...
void draw_scene()
{
	...
	model_pos = glm::rotate(model_pos, glm::radians(90.0f), glm::vec3(1, 0, 0));
	++cur_ind;
	//model_pos = glm::rotate(model_pos, glm::radians(0.0f), glm::vec3(1, 0, 0));
	//draw_object(cur_ind, 0, 0, 5.5, m_ambient, m_diffuse, m_specular, m_emission, m_shininess);
	//model_pos = glm::rotate(model_pos, glm::radians(90.0f), glm::vec3(1, 0, 0));
	++cur_ind;
	draw_object(cur_ind, 0.0, 6.5, 0.0, m_ambient, m_diffuse, m_specular, m_emission, m_shininess);
	...
	draw_object(cur_ind, 0, 0, 0, material_ambient, material_diffuse, material_specular, material_emission, material_shininess);
